...
{
    private static readonly GUIStyle label = new() { fontSize = 20 };
    ...
    public static bool DrawExpandBox(Rect rect, string title, string content, bool expand, Color color, Color bg,
        float width)
    {
