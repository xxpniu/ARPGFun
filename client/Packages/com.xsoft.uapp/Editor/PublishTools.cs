...
public sealed class PublishTools
{
    ...
    private static void Build(string output, BuildTarget plat,
        BuildOptions op = BuildOptions.AcceptExternalModificationsToPlayer)
    {
    ...
    {
        (var op, var output, var plat, _) = ParserArgs();
