...
{
    private static readonly List<Type> _effects = new();
    ...
    private int index = -1;
    private Vector2 scrollProperty = Vector2.zero;
    ...
    private void OnGUI()
    {
        ...
        {
            var attrs =
                i.GetType().GetCustomAttributes(typeof(EditorEffectAttribute), false) as EditorEffectAttribute[];
