...
namespace Windows
{
    ...
    partial class UUIPackage : UUIAutoGenWindow
    {
        ...
        protected TextMeshProUGUI TextSizeTitle;
        protected TextMeshProUGUI lb_TextCountCur;
        protected TextMeshProUGUI lb_TextCountSize;
        ...
        protected override void InitTemplate()
        {
            ...
            TextSizeTitle = FindChild<TextMeshProUGUI>("TextSizeTitle");
            lb_TextCountCur = FindChild<TextMeshProUGUI>("lb_TextCountCur");
            lb_TextCountSize = FindChild<TextMeshProUGUI>("lb_TextCountSize");
