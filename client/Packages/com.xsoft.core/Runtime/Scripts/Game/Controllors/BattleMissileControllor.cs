        ...
        public override GAction GetAction(GTime time, GObject current)
        {
            ...
            switch (missile.State)
            {
                case MissileState.NoStart:
                {
                    ...
                    re.OnEvent(EventType.EVENT_MISSILE_CREATE, missile.Target);
                }
                ...
                case MissileState.Moving:
                {
                    ...
                    {
                        re.OnEvent(EventType.EVENT_MISSILE_HIT, missile.Target);
                ...
                {
                    re.OnEvent(EventType.EVENT_MISSILE_DEAD, missile.Target);
