...
namespace GameLogic.Game.LayoutLogics
{
	...
	public static class LayoutBaseLogic
    {
        ...
        public static void DamageActive(TimeLinePlayer linePlayer, LayoutBase layoutBase)
        {
            ...
            if (targetPos == null) throw new Exception("Do not have target of origin. type:" + layout.target);
            ...
            if (string.IsNullOrEmpty(layout.effectKey)) return;
            ...
            {
                if (!t) continue;
                foreach (var i in group.effects) EffectBaseLogic.EffectActive(t, i, releaser);
            }
        }
        ...
        public static void LaunchSelfActive(TimeLinePlayer linePlayer, LayoutBase layoutBase)
        {
            ...
            character.BeginLaunchSelf(character.Rotation,
                ...
                (hit, obj) =>
                {
                    ...
                    if (r.TryHit(hit)) r.OnEvent(EventType.EVENT_MISSILE_HIT, hit);
                },
                releaser);
        }
