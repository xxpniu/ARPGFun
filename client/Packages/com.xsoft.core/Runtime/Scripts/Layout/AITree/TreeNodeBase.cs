...
namespace Layout.AITree
{
    ...
    public class TreeNodeSetIntKey : TreeNode
    {
        ...
        [Label("比较方式")] public OperatorType operatorType = OperatorType.Reset;

        [Label("操作值")] public FieldValue OperatorValue = 0;
    }
}