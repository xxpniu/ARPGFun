...
namespace Layout
{
    ...
    public class EffectGroup
    {
        ...
        [EditorEffectsAttribute] public List<EffectBase> effects;

        [Label("标记")] public string key;
    ...
    public class EventContainer
    {
        ...
        [Label("事件相应Layout")] [LayoutPath] public string layoutPath;

        [XmlIgnore] public TimeLine line;

        [Label("类型")] public EventType type;
