...
namespace BattleViews.Components
{
    ...
    {
        private readonly List<DebugOfRange> _ranges = new();
...
#if UNITY_EDITOR
                Handles.Label(i.Pos, string.Format("A{1:0.0}_R{2:0.0}_{0}", i.targetsNums, i.Angle, i.Radius));
#endif
            }
        }
