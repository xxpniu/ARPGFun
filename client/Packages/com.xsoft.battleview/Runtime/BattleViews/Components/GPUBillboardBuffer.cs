...
//DelayTime + ScaleTime1 + ScaleTime2 = NormalTime
    ...
    public class GPUBillboardBuffer : XSingleton<GPUBillboardBuffer>
    {
        ...
        private const int BC_TEXTURE_ROW_COLUMN = 4;
        ...
        public uint mMaxBoardSize;
        private Vector3 lifeParam;


        private Vector4[] m_SpeedParam; // XinitialSpeed,YinitialSpeed ,XAcceleration,YAcceleration
        private Vector4[] m_TimeParam; // NormalTime,FadeTime,DelayTime,Maxsize,
        private Vector4[] m_TimeParamExtra; //ScaleTime1,EndSize,ScaleTime2
        private uint mBoardIndex;
        private MeshFilter mFilter;


        private GameObject mGameObject;
        private Material mMaterial;
        private Vector3 mPosOffset = Vector3.zero;
        private MeshRenderer mRenderer;

        private Vector2 mUVIncrease;
        private Vector2 randomacceleration;
        ...
        private void GPUBillboardBufferInit()
        {
            ...
            mGameObject.transform.SetParent(transform, false);
