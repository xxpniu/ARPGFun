...
public class UApplication : XSingleton<UApplication>
{
    ...
    private async Task<T> ChangeGate<T>(params object[] args) where T : UGate, new()
    {
        ...
        if (old != null) await UGate.DoExitGate(old);
        //Destroy(old);
        _gate = nGate;
        return nGate;
    }
    ...
    protected override void Awake()
    {
        ...
        LoginServer = new ServiceAddress { IpAddress = clientConfig.LoginServerHost, Port = clientConfig.LoginServerPort };
