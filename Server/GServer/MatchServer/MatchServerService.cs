    ...
    public class MatchServerService:Proto.MatchServices.MatchServicesBase
    {
        ...
        private async Task<(string id, BattleServerConfig config)> StartBattleServer(IList<string> player, int levelID)
        {
            ...
            try
            {
                ...
                var client = channel.CreateClient<BattleInnerServices.BattleInnerServicesClient>();
        ...
        public async override Task<M2S_CreateMatchGroup> CreateMatchGroup(S2M_CreateMatchGroup request, ServerCallContext context)
        {
        ...
        public async override Task<M2S_StartMatch> StartMatch(S2M_StartMatch request, ServerCallContext context)
        {
        ...
        public async override Task<M2S_TryToReJoinMatch> TryToReJoinMatch(S2M_TryToReJoinMatch request, ServerCallContext context)
        {
        ...
        public override async Task<M2S_JoinMatchGroup> JoinMatchGroup(S2M_JoinMatchGroup request, ServerCallContext context)
        {
            ...
            return new M2S_JoinMatchGroup { Code = res ? ErrorCode.Ok : ErrorCode.InMatch };
        }
        ...
        public override async Task<M2S_LeaveMatchGroup> LeaveMatchGroup(S2M_LeaveMatchGroup request, ServerCallContext context)
        {
            ...
            return new M2S_LeaveMatchGroup { Code = res ? ErrorCode.Ok : ErrorCode.Error };
        }
        ...
        public override async Task<M2S_KillUser> KllUser(S2M_KillUser request, ServerCallContext context)
        {
            ...
            await chn.CreateClient<BattleInnerServices.BattleInnerServicesClient>().KillUserAsync(new M2B_KillUser { UserID =request.UserID });
            await chn.ShutdownAsync();
